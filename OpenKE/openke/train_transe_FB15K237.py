...
# define the model
transe = TransE(ent_tot=train_dataloader.get_ent_tot(), rel_tot=train_dataloader.get_rel_tot(), dim=1, p_norm=1, norm_flag=False)
...
trainer.run()
transe.save_checkpoint('./checkpoint/transe_100.ckpt')

# test the model
transe.load_checkpoint('./checkpoint/transe_100.ckpt')
